...
class InformationRetrieval:
    ...
    def buildIndex(self, docs, docIDs):
        ...
        self.docIDs = docIDs
        try:
            with open(os.path.join(self.root_folder, "vocab_list.pkl"), "rb") as fp:  # Unpickling
            ...
            with open(os.path.join(self.root_folder, "vocab_list.pkl"), "wb") as fp:  # Pickling
        ...
        try:
            with open(os.path.join(self.root_folder, "index_df.pkl"), "rb") as fp:  # Unpickling
            ...
            index_df.pop('n_i')
            with open(os.path.join(self.root_folder, "index_df.pkl"), "wb") as fp:  # Pickling
    ...
    def buildIndex2(self, docs, docIDs):
        ...
        try:
            ...
            self.pipe_bi = Pipeline(
                [('count', CountVectorizer(tokenizer=dummy, preprocessor=dummy, ngram_range=(2, 2), max_df=0.3,
                                           min_df=1)),
                 ('tfid', TfidfTransformer(smooth_idf=False, sublinear_tf=True))]).fit(docs)
